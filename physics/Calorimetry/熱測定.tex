...
\begin{enumerate}
    \item \ce{CuS04*5H2O}をメノウ乳鉢で粉砕した。
    \item 空のアルミパンを用いて測定器の質量系を0補正したのち、粉砕した\ce{CuS04*5H2O}をアルミパンに入れ、測定器にセットした。質量は14.20 mgであった。
    \item 同様に、\ce{KNO3}を粉砕、測定器にセットした。質量は hogehoge%%
